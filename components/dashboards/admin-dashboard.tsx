...
import { LayoutDashboard, Package, ShoppingCart, CreditCard, Users, Activity, ChevronLeft } from "lucide-react"
...
export function AdminDashboard({ username, onLogout }: AdminDashboardProps) {
  ...
  return (
    <div className="flex h-[100dvh] bg-background relative mobile-overflow-hidden overflow-hidden">
      <AdminSidebar currentView={currentView} onViewChange={handleViewChange} onLogout={onLogout} username={username} />
